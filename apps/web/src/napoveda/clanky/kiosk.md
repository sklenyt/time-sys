...
Živě se aktualizující tabulka výsledků: pořadí, kategorie, pořadí v kategorii, jméno a čas — plus hodiny a štítek se stavem trati: „PŘED STARTEM“, „● ŽIVĚ“, nebo „UKONČENO“ (jakmile organizátor trať ve Správě akcí označí jako dokončenou). Tabulka se sama pomalu posouvá nahoru a dolů, pokud se výsledky nevejdou na jednu obrazovku najednou, s pauzou nahoře a dole, ať se dá čtení dohnat.
